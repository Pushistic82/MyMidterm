	...
	<div class="site-aligner">
            ...
            <div class="cols"><h2><?php echo get_theme_mod('contact_title',__('Our Location','skt_bakery')); ?></h2>
                ...
                <?php if( get_theme_mod('contact_no')){ ?>
                    <div class="foot-label"><?php _e('Call to contact me : ','skt_bakery'); ?></div><div class="add-content"><?php echo get_theme_mod('contact_no',__('+9876543210','skt_bakery')); ?></div><div class="clear"></div>
                <?php } ?>
       ...
       <div class="widget-column">
                <div class="cols"><h2><?php _e('Website Menu','skt_bakery'); ?></h2>
	...
	<?php $args = array( 'posts_per_page' => 2, 'post__not_in' => get_option('sticky_posts'), 'orderby' => 'date', 'order' => 'desc' );
			query_posts( $args ); ?>
				<ul class="recent-post">
                    ...
                    <?php endwhile; ?>
                    <?php else : ?>
                    <li><a href="#"><img width="51" height="51" src="<?php echo get_template_directory_uri(); ?>/images/creamy-cake.jpg">Lorem ipsum dolor sit amet</a><br><p>Sed nec pellentesque lacus. Aliqu aliquet leo eget metus</p></li><li></li>
                    <?php endif; ?>
                </ul>
                </div><!-- cols -->
        </div><!-- widget-column -->
        <div class="widget-column last">
       		<?php if(!dynamic_sidebar('twitter-wid')) : ?>
                <div class="cols"><h2><?php _e('School Information','skt_bakery'); ?></h2>
                   <p><?php _e('My major is MMP. I am a student of BMCC','skt_bakery'); ?></p>
                </div><!-- cols -->
            <?php endif; ?>
