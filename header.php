...
<div class="clear"></div>
<div class="slide_more"><a href="<?php the_permalink(); ?>"></a></div>
</div>
</div>      
<?php $i++; } ?>       
 </div>
...
<img src="<?php echo get_template_directory_uri(); ?>/images/slides/slider1.jpg" alt="We Create Delicious Memories " title="#slidecaption1" /><img src="<?php echo get_template_directory_uri(); ?>/images/slides/slider2.jpg" alt="Candle Ready Cakes " title="#slidecaption2" /><img src="<?php echo get_template_directory_uri(); ?>/images/slides/slider3.jpg" alt="Delicious Cookies " title="#slidecaption3" /></div>                    
                <div id="slidecaption1" class="nivo-html-caption">
                    <div class="slide_info">
                            <h1><?php echo 'Sweets Make My Life Easier';?></h1>
                            <p><?php echo 'So many pleasant things around me.';?></p>
                            <div class="clear"></div>
                            <div class="slide_more"></div>
                    </div>
                    </div><div id="slidecaption2" class="nivo-html-caption">
                    <div class="slide_info">
                            <h1><?php echo 'I Love Tasty Things!'; ?></h1>
                            <p><?php echo 'I just need to go to the one of my favorite bakeries for it.';?></p>
                            <div class="clear"></div>
                            <div class="slide_more"></div>
                    </div>
                    </div><div id="slidecaption3" class="nivo-html-caption">
                    <div class="slide_info">
                            <h1><?php echo 'Delicious Cookies and Cakes';?></h1>
                            <p><?php echo 'They make me feel happy and optimistic about my future.'; ?> </p>
                            <div class="clear"></div>
                            <div class="slide_more"></div>
                    </div>
                    </div>
...
<div class="feature-box-main site-aligner">
        ...
        <?php the_content(); 
		endwhile; } else { ?>
        <h2><?php echo 'I can find pleasure and taste in every bite'; ?></h2>
        <p><?php echo '';?></p>
        <?php 
		}
		/*Home Section Content*/
...
<div class="feature-box-main site-aligner">
        ...
        <?php the_content(); 
		endwhile; } else { ?>
        <h2><?php echo 'I find pleasure and taste in every bite'; ?></h2>
        <p><?php echo '';?></p>
        <?php 
		}
		/*Home Section Content*/
...
?>
<div id="cookieLover"><?php cookieLover(); ?></div>
